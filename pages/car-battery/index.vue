      ...
      <div class="w-full">
        ...
        >
          ...
          <div id="first" class="absolute w-full opacity-0 active">
            ...
            <slider-battery :contents="volta.car" />
          </div>
          <!-- volga -->
          <div id="second" class="absolute w-full opacity-0 invisible">
            ...
            <slider-battery :contents="volga.car" />
          </div>
          <!-- cene -->
          <div id="third" class="absolute w-full opacity-0 invisible">
            ...
            <slider-battery :contents="cene.car" />
          </div>
          <!-- turbo -->
          <div id="fourth" class="absolute w-full opacity-0 invisible">
            ...
            <slider-battery :contents="turbo.car" />
          </div>
          <!-- silver -->
          <div id="fifth" class="absolute w-full opacity-0 invisible">
            ...
            <slider-battery :contents="silver.car" />
          </div>
          <!-- shark -->
          <div id="sixth" class="absolute w-full opacity-0 invisible">
            ...
            <slider-battery :contents="shark.car" />
          </div>
        </div>
      </div>
    </div>
